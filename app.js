...
/* =============================================================
   🔒 Arcatdia Battle Engine - Part 3/4 (中央細碟過場與舊版高度還原)
   ============================================================= */
...
// 🎯 還原舊相片黃金掣位高度：底部貼緊四色色塊，絕不懸空浮起！
function getGeometry() {
    const radius = 28; 
    const circleCenterY = H - 105; // 還原舊相高度！
